...
public enum CItemControlCategory {
	...
	CC4("КК4","КК4 (Идентификация, хранение (без задания некоторых/изменения всех атрибутов))");

	private String label;

	private String description;

	private CItemControlCategory(String label, String description) {
		this.label = label;
